Math.randomString = function(e) {
   ...
   var LobiPanel = function($el, options) {
      ...
      var $heading, $body, innerId, me = this,
         _processInput = function(e) {
            ...
            e = $.extend({}, $.fn.lobiPanel.DEFAULTS, e, n);
            for (var i = ["unpin", "reload", "expand", "minimize", "close", "editTitle"], t = 0; t < i.length; t++) {
               var o = i[t];
               "object" == typeof e[o] && (e[o] = $.extend({}, $.fn.lobiPanel.DEFAULTS[o], e[o], n[o]))
            }
            return e
         },
         _init = function() {
            me.$el.addClass("lobipanel"), me.$el.data("inner-id") || me.$el.attr("data-inner-id", Math.randomString(10)), $heading.append(_generateControls()), innerId = me.$el.data("inner-id");
            var e = me.$el.parent();
         ...
         _generateDropdown = function() {
            var e = $('<div class="dropdown"></div>').append('<ul class="dropdown-menu dropdown-menu-right"></ul>').append('<div class="dropdown-toggle" data-toggle="dropdown"><span class="' + LobiPanel.PRIVATE_OPTIONS.iconClass + " " + me.$options.toggleIcon + '"></div>');
            return e
         },
         _generateEditTitle = function() {
            var e = me.$options.editTitle,
               n = $('<a data-func="editTitle"></a>');
            return n.append('<i class="' + LobiPanel.PRIVATE_OPTIONS.iconClass + " " + e.icon + '"></i>'), e.tooltip && "string" == typeof e.tooltip && (n.append('<span class="control-title">' + e.tooltip + "</span>"), n.attr("data-tooltip", e.tooltip)), _onEditTitleClick(n), $("<li></li>").append(n)
         },
         ...
         _generateUnpin = function() {
            ...
            return n.append('<i class="' + LobiPanel.PRIVATE_OPTIONS.iconClass + " " + e.icon + '"></i>'), e.tooltip && "string" == typeof e.tooltip && (n.append('<span class="control-title">' + e.tooltip + "</span>"), n.attr("data-tooltip", e.tooltip)), _onUnpinClick(n), $("<li></li>").append(n)
         },
         ...
         _generateReload = function() {
            ...
            return n.append('<i class="' + LobiPanel.PRIVATE_OPTIONS.iconClass + " " + e.icon + '"></i>'), e.tooltip && "string" == typeof e.tooltip && (n.append('<span class="control-title">' + e.tooltip + "</span>"), n.attr("data-tooltip", e.tooltip)), _onReloadClick(n), $("<li></li>").append(n)
         },
         ...
         _generateMinimize = function() {
            ...
            return n.append('<i class="' + LobiPanel.PRIVATE_OPTIONS.iconClass + " " + e.icon + '"></i>'), e.tooltip && "string" == typeof e.tooltip && (n.append('<span class="control-title">' + e.tooltip + "</span>"), n.attr("data-tooltip", e.tooltip)), _onMinimizeClick(n), $("<li></li>").append(n)
         },
         ...
         _generateExpand = function() {
            var e = me.$options.expand,
               n = $('<a data-func="expand"></a>');
            return n.append('<i class="' + LobiPanel.PRIVATE_OPTIONS.iconClass + " " + e.icon + '"></i>'), e.tooltip && "string" == typeof e.tooltip && (n.append('<span class="control-title">' + e.tooltip + "</span>"), n.attr("data-tooltip", e.tooltip)), _onExpandClick(n), $("<li></li>").append(n)
         },
         ...
         _generateClose = function() {
            ...
            return n.append('<i class="' + LobiPanel.PRIVATE_OPTIONS.iconClass + " " + e.icon + '"></i>'), e.tooltip && "string" == typeof e.tooltip && (n.append('<span class="control-title">' + e.tooltip + "</span>"), n.attr("data-tooltip", e.tooltip)), _onCloseClick(n), $("<li></li>").append(n)
         },
         ...
         _initFromHTML = function() {
            ...
            }), me.$options.minWidth = me.$el.attr("data-min-width") || $.fn.lobiPanel.DEFAULTS.minWidth, me.$options.maxWidth = me.$el.attr("data-max-width") || $.fn.lobiPanel.DEFAULTS.maxWidth, me.$options.minHeight = me.$el.attr("data-min-height") || $.fn.lobiPanel.DEFAULTS.minHeight, me.$options.maxHeight = me.$el.attr("data-max-height") || $.fn.lobiPanel.DEFAULTS.maxHeight, me.$options.draggable = void 0 === me.$el.attr("data-draggable") ? $.fn.lobiPanel.DEFAULTS.draggable : ["false", "0"].indexOf(me.$el.attr("data-draggable").toLowerCase()) > -1 ? !1 : !0, me.$options.loadUrl = me.$el.attr("data-load-url") || $.fn.lobiPanel.DEFAULTS.loadUrl, me.$options.resize = me.$el.attr("data-resize") || $.fn.lobiPanel.DEFAULTS.resize
         },
         _getMaxZIndex = function() {
            var e = $(".lobipanel.panel-unpin:not(.panel-minimized.panel-expanded)");
            ...
            var n, i = $(e[0]).attr("style"),
               t = $(e[0]).data("inner-id");
            n = i ? i.getCss()["z-index"] : LobiPanel.PRIVATE_OPTIONS.initialZIndex;
         ...
         _changeClassOfControl = function(e) {
            ...
            n.icon && e.find("." + LobiPanel.PRIVATE_OPTIONS.iconClass).toggleClass(n.icon).toggleClass(n.icon2)
         },
         _getFooterForMinimizedPanels = function() {
            var e = $("." + LobiPanel.PRIVATE_OPTIONS.toolbarClass);
            return 0 === e.length && (e = $('<div class="' + LobiPanel.PRIVATE_OPTIONS.toolbarClass + '"></div>'), $("body").append(e)), e
         },
         ...
         _appendInnerIdToParent = function(e, n) {
            if (void 0 === e.attr(LobiPanel.PRIVATE_OPTIONS.parentAttr)) e.attr(LobiPanel.PRIVATE_OPTIONS.parentAttr, n);
            else {
               if (e.attr(LobiPanel.PRIVATE_OPTIONS.parentAttr).indexOf(n) > -1) return;
               var i = e.attr(LobiPanel.PRIVATE_OPTIONS.parentAttr);
               e.attr(LobiPanel.PRIVATE_OPTIONS.parentAttr, i + " " + n)
            }
            me.$el.attr("data-index", me.$el.index())
         },
         _insertInParent = function() {
            var e = $("[" + LobiPanel.PRIVATE_OPTIONS.parentAttr + "~=" + innerId + "]");
         ...
         _enableSorting = function() {
            var e = me.$el.parent();
            e.hasClass("ui-sortable") && e.sortable("destroy"), me.$options.sortable ? (me.$el.addClass("lobipanel-sortable"), e.addClass("lobipanel-parent-sortable")) : me.$el.removeClass("lobipanel-sortable"), e.sortable({
         ...
         _removeInnerIdFromParent = function(e) {
            var n = $("[" + LobiPanel.PRIVATE_OPTIONS.parentAttr + "~=" + e + "]"),
               i = n.attr(LobiPanel.PRIVATE_OPTIONS.parentAttr).replace(e, "").trim().replace(/\s{2,}/g, " ");
            n.attr(LobiPanel.PRIVATE_OPTIONS.parentAttr, i)
         },
         ...
         _triggerEvent = function(e) {
            ...
            n.unshift(me), me.$el.trigger(e + ".lobiPanel", n)
         };
      this.isPanelInit = function() {
         return me.$el.hasClass("lobipanel") && me.$el.data("inner-id") ? !0 : !1
         ...
         if (me.isPinned()) $body.slideDown(), me.$el.find(".panel-footer").slideDown(), me.$el.removeClass("panel-collapsed"), _changeClassOfControl($heading.find('[data-func="minimize"]'));
            ...
            me.$el.css({
               ...
               0 === e.children().length && e.remove(), $("body").removeClass("lobipanel-minimized"), $("body").addClass("lobipanel-minimized");
         ...
         var i = $("." + LobiPanel.PRIVATE_OPTIONS.toolbarClass),
            t = i.outerHeight() || 0;
   ...
   $.fn.lobiPanel = function(e) {
      var n, i = arguments;
      return this.each(function() {
         var t = $(this),
            o = t.data("lobiPanel"),
            a = "object" == typeof e && e;
         o || t.data("lobiPanel", o = new LobiPanel(t, a)), "string" == typeof e && (i = Array.prototype.slice.call(i, 1), n = o[e].apply(o, i))
      }), n
